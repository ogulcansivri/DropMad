...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Permissions-Zero%20Config%20Required-success?style=flat-square" alt="Zero Permissions">
...
- 🚀 **Zero-Permission Menu Bar Access:** Click the tray icon at any time to toggle the floating shelf instantly.
...
|---|---|
| **Toggle Shelf** | Click the Menu Bar icon (top-right tray) |
...
| **Menu Bar Options** | Right-click tray icon for language switcher and settings |
...
Download the latest **`DropMad-1.0.0.dmg`** from the [Releases](https://github.com/ogulcansivri/DropMad/releases) page and drag `DropMad.app` to your `/Applications` folder.
...
- 🚀 **Sıfır İzin & Menü Çubuğu:** Sağ üstteki simgeye tek tıkla rafı hemen açıp kapatabilirsiniz; hiçbir sistem erişim izni gerektirmez.
...
### 🖱️ Kullanım ve Kontroller
| Eylem | Nasıl Yapılır? |
|---|---|
| **Rafı Aç / Kapat** | Sağ üst menü çubuğundaki simgeye sol tıkla |
...
| **Menü Seçenekleri** | Menü simgesine sağ tıkla (Dil seçimi, Kılavuz, Çıkış) |
